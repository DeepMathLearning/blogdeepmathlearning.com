  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight" style="color: #1619ac">Deep Math Learning</div>
        <!-- <div class="text-green-700 leading-tight">Powered by Vue.js &amp; Tailwind v1</div> -->
        <div class="text-green-700 leading-tight" style="color: #626262">Grupo dedicado
a la investigación, divulgación y desarrollo
de soluciones potenciadas por la
matemática aplicada a la inteligencia
artificial</div>
      </div>
      <div class="mt-12 sm:mt-0" style="width: 400px; height: 300px">
        <g-image src="../../static/developer.jpg" alt="hero" class="mx-auto sm:mx-0" />
      </div>
    </div> <!-- end hero -->
    ...
    <div class="container-inner mx-auto">
     <!--  <p class="text-lg sm:text-xl">This gridsome theme was forked from my <a href="https://andremadarang.com">personal website</a>. I added more features and decided to release it as an open source project. Check it out on <a href="https://github.com/drehimself/gridsome-portfolio-starter">GitHub</a> or check out the <a href="https://www.youtube.com/watch?v=uHo6o1TNQeE">screencast I did</a>. Feel free to use it for your own site or projects! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima, repellat. Dolores iure, quas perspiciatis rerum quaerat atque eum repellat autem.</p> -->
      <p class="text-lg sm:text-xl">Nuestro objetivos es ser participe del
crecimiento científico de la matemática
aplicada a la IA desarrollando artículos
científicos de calidad y llevar a cabo
proyectos de IA aplicados a la vida real
...
de la ciencia a la cual las matemáticas y
la inteligencia artificial puedan ser
aplicadas.</p>

      <div class="flex justify-between items-center py-6">
        <div class="w-full sm:w-1/2 px-8 py-8 sm:py-0">
          <g-image src="../../static/mind_map.jpg" alt="browser" />
        </div>
        <div class="w-1/2 px-8 hidden sm:flex justify-end">
          <g-image src="../../static/code_review.jpg" alt="mobile" />
        </div>
      </div>
    </div>
