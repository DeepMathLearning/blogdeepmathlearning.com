<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700" style="border-color: #1619ac">
...
<!--         <div>
          ...
          <g-link v-else to="/"><g-image src="../../static/logo_dark.png" class="w-40" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600" data-cypress="projects">Proyectos</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Projects</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-copy-primary hover:text-gray-600" data-cypress="about">Sobre mi</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">About</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'" class="text-copy-primary hover:text-gray-600" data-cypress="contact">Contactame</a>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:deepmathlearning@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.youtube.com/" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/DeepMathLearning" target="_blank" class="text-white hover:text-gray-400">
